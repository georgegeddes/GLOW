...
C
     ...
     |  (/1.42, 3.54,12.70, 5.20, 0.86, 0.45, 1.00, 1.00, 0.,0./)
      ...
      THI(1:nei,1)=
     |  (/13.60,16.90,18.50,13.88, 0.00, 0.00, 0.00, 0.,0.,0./)
      THI(1:nei,2)=
     ...
     |  (/15.58,16.73,18.75,22.00,23.60,40.00, 0.00, 0.,0.,0./)
      ...
      AK(1:nei,1)=
     |  (/ 1.13, 1.25, 0.67, 0.92, 0.00, 0.00, 0.00, 0.,0.,0./)
      AK(1:nei,2)=
     ...
     |  (/2.42, 1.06, 0.55, 0.37, 0.37, 0.53, 0.00, 0.,0.,0./)
      ...
      AJ(1:nei,1)=
     |  (/1.81, 1.79, 1.78,13.88, 0.00, 0.00, 0.00, 0.,0.,0./)
      AJ(1:nei,2)=
     ...
     |  (/1.74, 1.74, 1.74, 1.74, 1.74, 1.74, 0.00, 0.,0.,0./)
      ...
      TS(1:nei,1)=
     |  (/6.41, 6.41, 6.41, 6.41, 0.00, 0.00, 0.00, 0.,0.,0./)
      TS(1:nei,2)=
     ...
     |  (/1000.,1000.,1000.,1000.,1000.,1000.,   0., 0.,0.,0./)
      ...
      TB(1:nei,1)=
     |  (/162.00,162.0,162.0,162.0, 0.00, 0.00, 0.00, 0.,0.,0./)
      TB(1:nei,2)=
     ...
     |  (/31.16,33.46,37.50,44.00,47.20,80.00, 0.00, 0.,0.,0./)
      ...
      GAMS(1:nei,1)=
     |  (/13.00,13.0,13.00,13.00, 0.00, 0.00, 0.00, 0.,0.,0./)
      GAMS(1:nei,2)=
     ...
     |  (/13.80,13.8,13.80,13.80,13.80,13.80, 0.00, 0.,0.,0./)
      ...
      GAMB(1:nei,1)=
     |  (/-.815,-.815,-.815,-.815, 0.00, 0.00, 0.00, 0.,0.,0./)
      GAMB(1:nei,2)=
